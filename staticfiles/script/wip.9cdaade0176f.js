...
export async function getPosts(){
    ...
    for (const idx in allPosts){
        ...
        <div class="chart-footer-data">
        </div>
        `
        // const ftrData = postDiv.querySelector('chart-footer-data')
        // let img = document.createElement('img')
        // img.innerHTML = `<img src="{% static '/img/icons8-spreadsheet.svg' %}" class="posts-footer-icon"/>`
        // ftrData.appendChild(img)
